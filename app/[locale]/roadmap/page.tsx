...
const ROADMAP = [
  ...
  },
  {
    phase: '03',
    status: 'done',
    titleEn: 'Export Workflow',
    titleZh: '独立文件格式导出',
    items: [
      { en: 'Standalone HTML export', zh: '独立 HTML 文件导出' },
      { en: 'PDF portfolio export', zh: 'PDF 作品集导出' },
      { en: 'Word document export', zh: 'Word 文档导出' },
      { en: 'Complete offline workflow', zh: '完整离线工作流' },
    ],
  },
  {
    phase: '04',
    status: 'done',
    titleEn: 'Dedicated File Format Refinement',
    titleZh: '专属独立文件格式完善',
    items: [
      { en: 'Custom layout templates per format', zh: '各格式专属排版模板' },
      { en: 'Fine-tuned PDF typography & spacing', zh: 'PDF 精细排版与间距调节' },
      { en: 'Word style consistency & heading system', zh: 'Word 样式一致性与标题体系' },
      { en: 'HTML self-contained asset bundling', zh: 'HTML 独立资源打包' },
    ],
  },
  {
    phase: '05',
